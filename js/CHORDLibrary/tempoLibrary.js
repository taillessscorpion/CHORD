const tempoLibrary = {};
tempoLibrary.tempoMeter = (inputElement, outputValueElement, outputUnitElement) => {
    ...
    const countBeat = () => {
        ...
        beatsCounted += 1
        outputValueElement.innerText = tempoLibrary.tempoHeader(beatsCounted, miliSecondsPassed)
...
tempoLibrary.tempoHeader = (beats, miliSeconds) => {
